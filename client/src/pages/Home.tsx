    ...
    <section className="py-10 sm:py-12 md:py-16 lg:py-10 bg-white contain-layout">
      <div className="container mx-auto px-4">
        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          <button
            onClick={() => scroll('left')}
            className="absolute left-0 top-1/2 -translate-y-1/2 -translate-x-2 sm:-translate-x-4 md:-translate-x-6 lg:-translate-x-8 z-10 w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 bg-white rounded-full shadow-lg border border-gray-200 flex items-center justify-center hover:bg-gray-50 hover:shadow-xl transition-all duration-300 group"
            aria-label="Previous"
          >
          ...
          <button
            ...
            className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-2 sm:translate-x-4 md:translate-x-6 lg:translate-x-8 z-10 w-8 h-8 sm:w-10 sm:h-10 md:w-12 md:h-12 bg-white rounded-full shadow-lg border border-gray-200 flex items-center justify-center hover:bg-gray-50 hover:shadow-xl transition-all duration-300 group"
            aria-label="Next"
          >
          ...
          >
            ...
            >
              ...
              {doctors.map((doc, index) => (
                <div
                  key={`first-${index}`}
                  className="flex-shrink-0 w-[280px] md:w-[320px] bg-white rounded-2xl overflow-hidden border border-gray-200 hover:border-primary/30 hover:shadow-md transition-all duration-300 cursor-pointer group"
                ...
                >
                  ...
                  <div className="p-6 pb-7 text-center bg-white">
...
export default function Home() {
  ...
  // Autoplay plugin for testimonials carousel - infinite loop without stopping
  const autoplayPlugin = useRef(
    Autoplay({ delay: 3000, stopOnInteraction: false, stopOnMouseEnter: true, stopOnFocusIn: false, playOnInit: true })
  );
      ...
      <section id="reviews" className="compact-section bg-slate-50 contain-layout">
        <div className="container mx-auto px-4">
            ...
            <div className="flex items-center justify-center gap-3 mt-4">
              <div className="flex items-center gap-2 bg-white px-4 py-2 rounded-full shadow-sm border border-gray-200">
                ...
                <div className="text-left">
                  <div className="text-xs font-semibold text-gray-900">Recenzii Google</div>
          ...
          <div className="text-center mt-8">
            <a
              href="https://www.google.com/search?q=cristalexdent&oq=cristalexdent+&gs_lcrp=EgZjaHJvbWUyBggAEEUYOTIGCAEQRRg7MggIAhAAGA0YHjIHCAMQABjvBTIGCAQQRRg8MgYIBRBFGD0yBggGEEUYPTIGCAcQRRg90gEINjIzNWowajeoAgCwAgA&sourceid=chrome&ie=UTF-8#lrd=0x40c97d8f45cc6361:0xe7a27095dc95ae87,1,,,,"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-white hover:bg-gray-50 text-gray-900 font-semibold px-6 py-3 rounded-full shadow-md border-2 border-gray-200 hover:border-primary transition-all"
            >
              <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z" fill="#4285F4"/>
                <path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z" fill="#34A853"/>
