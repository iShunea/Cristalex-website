    ...
    return [
      {
        ...
        titleRo: "Cum să Ajungi la Cristalexdent",
        titleRu: "Как Добраться до Cristalexdent",
        titleEn: "How to Get to Cristalexdent",
      ...
      },
      {
        ...
        descriptionRo: "Tehnologie modernă de albire dentară la Cristalexdent",
        descriptionRu: "Современная технология отбеливания зубов в Cristalexdent",
        descriptionEn: "Modern teeth whitening technology at Cristalexdent",
        displayOrder: 3,
        isActive: true,
